...
von \SI{35}{\degree} bis \SI{120}{\degree} abdecken lässt. Bei
\SI{270}{\degree} wird im späteren Verlauf die $^{133}\text{Ba}$- beziehungsweise die
$^{152}\text{Eu}$-Quelle so positioniert, das die Zählraten ungefähr gleich
sind. Das erreicht man dadurch, das man die Quellen näher oder weiter von
Kreiszentrum befestigt. 
In der Mitte befindet sich Vorrichtung, auf der sich Absorbermaterialien stellen lassen.
...
positioniert und der Ausgang des Photomultipieres über ein R-Stück mit dem
Oszilloskop verbunden. Man nutzt das T-Stück, damit es nicht zu Refelektionen
am Kabelende kommt. Als nächstes erhöhen wir die Hochspannung des
Photomultipliers von \SI{0}{\volt} auf \SI{700}{\volt} und erhalten \fehlt.

Nun verbinden wir den Detektor mit dem Verstärer und diesen mit der MCA-Karte
in Computer. Wir wählen die Verstärung so, dass der Photopeak des Spektrums
