...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{plot_data_raw_Ba}
    \caption{%
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{plot_data_raw_Eu}
    \caption{%
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{plot_peaks_Ba}
    \caption{%
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{plot_peaks_Eu}
    \caption{%
