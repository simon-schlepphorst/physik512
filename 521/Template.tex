...
Die $\gamma$-Strahlung entsteht, wenn nach einem vorher gegangen Zerfall der
...
wechselwirken.
Die Art dieser Wechselwirkung hängt von der Ordnungszahl der bestrahlten Atome
...
Hierbei gibt das Photon einen Teil seiner Energie an das Elektron ab und ändert da durch
seine Frequenz.
...
Durch den weitern Aufbau des Photomultiplieres kommt es zu einem Lawineneffekt,
welcher die Elektronen vervielfacht und somit ein Signal verstärkt.
...
Man erhält die Dotierung eines Kristalls, in dem man fremde Atome in den
Kristall einbindet.
...
dann den Kanal, der der Impulshöhe entspricht, hoch setzt. So erhalten wir ein
Histogramm.
...
innerhalb des Messbereiches liegt.
