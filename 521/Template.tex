...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\plotwidth]{CO_calib-peaks}
    \caption{%
	    Spitzen des $^{60}\text{Co}$-Spektrums aus dem Ge-Detektor
	    mit angepassten Gauß-Kurven
        %
    }
    \label{fig:}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\plotwidth]{CS_calib-peaks}
    \caption{%
	    Spitzen des $^{137}\text{Cs}$-Spektrums aus dem Ge-Detektor
	    mit angepassten Gauß-Kurven
        %
    }
    \label{fig:}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\plotwidth]{EU_calib-peaks}
    \caption{%
