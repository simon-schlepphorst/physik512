...
Nun wurden mit dem \emph{fpexperiment}-Programm
Driftzeitspektren bei verschiedenen Parametern aufgenommen.
Dazu wurde der Szintilationszähler unterhalbt der Driftkammer und orthogonal zu
...
Bei den folgenden Plots wurde der Übersichtlichkeit halber auf Fehlerbalken
verzichtet.
