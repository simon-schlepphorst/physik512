...
\section{Bauteile}
Die Beschreibungen der folgenden Bauteile orientiert sich an
\textcite{Nuclear-Physics_Leo}.
...
\begin{figure}
	...
	\end{subfigure}
	\caption{%
		Zerfallsschemata aus der Anleitung
	}
	\label{fig:zerfallsschema}
\end{figure}
\parencite{physik512-Anleitung}
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{TEK00046}
	\caption{%
		Slow-Fast Koinzidenz
	}
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{plot_langzeit_raw}
	\caption{%
		Lebenszeitkurve
	}
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{plot_time_calibration}
	\caption{%
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{plot_time_calibrate_fit}
	\caption{%
		Zeiteichung
	}
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{plot_langzeit}
	\caption{%
		Lebenszeitkurve mit Anpassung
	}
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{../graphics/fit_ranges}
	\caption{%
...
\begin{figure}
	\centering
	\includegraphics[width=\plotwidth]{../graphics/hist}
	\caption{%
...
Zuerst haben wir die Zeiteichung auf die Lebenszeitkurve angewand und
Abbildung~\ref{fig:langzeit_plot_daten} erhalten. Allerdings weisen unsere
Daten eine Schwebung auf, die das direkte Anpassen einer Funktion der folgenden
Form erschweren:
\begin{align}
	N\del{t} = N_0 \exp\del{\frac{1}{\tau}}
\end{align}
Deshalb haben wir untersucht, welche Lebenzeiten wir erhalten, wenn wir den
Bereich der Anpassung auf unterschiedlich lange Enden der Kurve beschränken.
Daraus erhalten wir Abbildung~\ref{fig:langzeit_fit_ranges}. Wenn wir nun die
Häufigkeiten der erhaltenen Lebenszeiten in ein Histogram eintragen (vgl.
Abbildung~\ref{fig:langzeit_hist}) können wir aus dieser Verteilung den
Mittelpunkt und die Abweichung bestimmen und erhalten für die Lebenszeit:
\begin{align*}
	\tau = \SI{11.07}{\nano\second} &&\Delta \tau =
	\SI{1.59}{\nano\second}
\end{align*}

Zum Literaturwert von $\tau = \SI{9.1}{\nano\second}$ ergibt das eine
Abweichung von $1.24 \sigma$. Das ist zwar kein sehr gutes Ergebnis, liegt aber
immer noch im erlaubten Rahmen.


\chapter{Ergebnis}
%TODO

Durch einen Fehler gab es eine Schwebung
auf dem gemessenen Spektrum. Wir können aber nicht schlüssig erklären, welcher
Fehler sich in dieser Weise äußern kann, wenn während der Durchführung keine
gravierenden Mängel aufgefallen sind.
Trotzdem liegen wir mit der ermittelten Lebenszeit in guter Nähe zum
Literaturwert.
